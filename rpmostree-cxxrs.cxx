...
extern "C"
{
  ...
  ::rust::repr::PtrLen
  rpmostreecxx$cxxbridge1$compose_baseimage (::rust::Vec< ::rust::String> *args) noexcept;
...
void
compose_baseimage (::rust::Vec< ::rust::String> args)
{
  ::rust::ManuallyDrop< ::rust::Vec< ::rust::String> > args$ (::std::move (args));
  ::rust::repr::PtrLen error$ = rpmostreecxx$cxxbridge1$compose_baseimage (&args$.value);
  if (error$.ptr)
    {
      throw ::rust::impl< ::rust::Error>::error (error$);
    }
